...
contract RedeemTest is BaseTest {
    ...
    uint256 public constant redeemableFLOW = 10e6 * 1e18;
    ...
    function setUp() public {
        ...
        FLOW.setRedemptionReceiver(address(receiver));
        ...
        FLOW.setMerkleClaim(address(claim));
    }
    ...
    function testClaimAirdrop() public {
        ...
        uint256 preBalance = FLOW.balanceOf(user);
        ...
        uint256 postBalance = FLOW.balanceOf(user);
